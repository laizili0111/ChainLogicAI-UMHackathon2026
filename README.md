...
* **AI Engine:** 3-Stage High-Availability Fallback Architecture (Layer 1: Ilmu GLM-5.1 | Layer 2: Groq GPT-OSS-120B | Layer 3: OpenRouter)
...
To enable the live AI reasoning engine, you must configure the Ilmu API settings in a local environment file. Never commit your real API key to GitHub.
...
```env
ILMU_API_KEY=your_primary_key_here
...
If you have Docker installed, you can spin up the entire application (both Frontend and Backend) with a single command. This ensures the environment is identical across all machines.

1. Ensure Docker Desktop is running.
2. From the root directory (`chainlogic-ai/`), run:
...
5. The Agentic AI Agent will automatically extract the affected SKU from the subject or body.
